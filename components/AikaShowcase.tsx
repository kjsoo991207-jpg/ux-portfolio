  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[2fr_3fr] gap-10 items-center py-10 md:py-16">
      ...
      <div className="flex flex-col items-start">
        <p className="font-mono text-[13px] font-bold tracking-[0.3em] text-emerald-400 uppercase mb-4">
          Aika
        </p>
        <h2 className="font-serif text-[36px] font-bold text-white leading-[1.2] tracking-tight">
        ...
        <div className="pt-8">
          <Link
            href="/work/aika"
            className="inline-block bg-emerald-500 text-black text-sm font-medium px-6 py-3 rounded-lg hover:bg-emerald-400 transition-colors"
          >
            View Work →
          </Link>
        </div>
      ...
      <div className="flex justify-center md:justify-end">
        <a
          ...
          style={{
            width: 320,
            filter: 'drop-shadow(0px 20px 40px rgba(16,185,129,0.08)) drop-shadow(0px 8px 16px rgba(0,0,0,0.3))',
          }}
        >
          <div
